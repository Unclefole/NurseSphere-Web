      ...
      <div className="container mx-auto px-4 py-8">
        <div className="flex items-center gap-4 mb-6">
          ...
          <div>
            ...
            <p className="text-gray-400 text-sm">Training and certification tracking</p>
          </div>
        </div>
        ...
        <div className="ns-card p-12 text-center">
          ...
          <h3 className="text-lg font-medium text-white mb-2">Education Module</h3>
          <p className="text-gray-400 mb-4">
            Training programs and certification management coming soon.
          </p>
